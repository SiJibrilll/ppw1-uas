...
<body>
    ...
    <div class="container">
        <a href="/chapters?comic_id=<?=$comic['id']?> " class="back-btn">← Back to Chapters Library</a>
        
        <div class="form-card">
            <h2 class="form-title">Create a new Chapter!</h2>

            <form method="POST" enctype="multipart/form-data" id="comicForm" action="/chapters?comic_id=<?=urlencode($comic['id'])?>">
                <?php if (!empty($errors)): ?>
                    <div style="color:red;">
                        <ul>
