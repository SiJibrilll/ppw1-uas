...
<body>
    ...
    <div class="container">
        <a href="/dashboard" class="back-btn">← Back to Comics Library</a>
            ...
            <form method="POST" enctype="multipart/form-data" id="comicForm" action="/comics/update">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" 
                              ...
                              placeholder="Enter comic description (optional)"><?= htmlspecialchars($old['description'] ?? '') ?></textarea>
                </div>
